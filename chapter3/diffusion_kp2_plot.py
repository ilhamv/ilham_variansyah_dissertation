...
# Load
BE      = np.genfromtxt('diffusion_kp2_BE.csv', delimiter=',')
MB      = np.genfromtxt('diffusion_kp2_MB.csv', delimiter=',')
...
plt.savefig('diffusion_runtime_kp2.svg', bbox_inches = 'tight', pad_inches = 0, dpi=1200)
plt.show()
...
plt.ylabel(r'Runtime, s')
plt.savefig('diffusion_eff_kp2.svg', bbox_inches = 'tight', pad_inches = 0, dpi=1200)
plt.show()