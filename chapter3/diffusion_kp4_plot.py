...
# Load
BE      = np.genfromtxt('diffusion_kp4_BE.csv', delimiter=',')
MB      = np.genfromtxt('diffusion_kp4_MB.csv', delimiter=',')
...
plt.savefig('diffusion_runtime_kp4.svg', bbox_inches = 'tight', pad_inches = 0, dpi=1200)
plt.show()
...
plt.ylabel(r'Runtime, s')
plt.savefig('diffusion_eff_kp4.svg', bbox_inches = 'tight', pad_inches = 0, dpi=1200)
plt.show()