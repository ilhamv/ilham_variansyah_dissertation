...
ax1.set_ylim([0.88698881659969, 3.3732348514065045])
...
plt.savefig('numerical_kp2.svg', bbox_inches = 'tight', pad_inches = 0, dpi=1200)
plt.show()
...
plt.savefig('numerical_refining_kp2.svg', bbox_inches = 'tight', pad_inches = 0, dpi=1200)
plt.show()
...
plt.plot(dt_list,first/first[-1]*4E-3,'--k',label='1st order')
plt.plot(dt_list,second/second[-1]*1E-6,':k',label='2nd order')
plt.legend(loc=0)
plt.grid()
plt.xscale('log')
plt.yscale('log')
...
plt.savefig('numerical_accuracy_kp2.svg', bbox_inches = 'tight', pad_inches = 0, dpi=1200)
plt.show()
...
plt.xlabel(r'$\Delta t$, s')
plt.ylabel(r'Relative error, %')
plt.savefig('numerical_Dsource_kp2.svg', bbox_inches = 'tight', pad_inches = 0, dpi=1200)
plt.show()